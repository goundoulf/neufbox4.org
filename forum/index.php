...
// Load the rss.php language file
require PUN_ROOT.'lang/'.$pun_user['language'].'/rss.php';
...
<div id="idx<?php echo $cat_count ?>" class="blocktable">
	<h2>
		<a href="rss.php?cid=<?php echo $cur_forum['cid'] ?>"><img src="img/feed.png" alt="<?php echo $lang_rss['RSS Feed'] ?>" /></a>

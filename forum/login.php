...
if (isset($_POST['form_sent']) && $action == 'in')
{
	...
	if (!$authorized)
		message($lang_login['Wrong user/pass'].' <a href="connexion?action=forget">'.$lang_login['Forgotten pass'].'</a>');
...
<div class="blockform">
	...
	<div class="box">
		<form id="request_pass" method="post" action="connexion?action=forget_2" onsubmit="this.request_pass.disabled=true;if(process_form(this)){return true;}else{this.request_pass.disabled=false;return false;}">
			<div class="inform">
				<fieldset>
...
<div class="blockform">
	...
	<div class="box">
		<form id="login" method="post" action="connexion?action=in" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
					<legend><?php echo $lang_login['Login legend'] ?></legend>
						<div class="infldset">
							...
							<p><a href="inscription" tabindex="4"><?php echo $lang_login['Not registered'] ?></a>&nbsp;&nbsp;
							<a href="connexion?action=forget" tabindex="5"><?php echo $lang_login['Forgotten pass'] ?></a></p>
						</div>
				</fieldset>
			</div>
